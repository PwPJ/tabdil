...
#test kilometre function
def test_kilometre():
	assert tabdil.length.kilometre(('km', 5)) == 5
	assert tabdil.length.kilometre(('m', 6)) == 0.006
	assert tabdil.length.kilometre(('cm', 600)) == 0.006
	assert tabdil.length.kilometre(('mm', 45000)) == 0.045	
	assert tabdil.length.kilometre(('inch', 35)) == 0.000889
